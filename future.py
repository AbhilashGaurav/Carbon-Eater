...
st.set_page_config(page_title='Monitoring Console', page_icon="ag logo.jpg")

# image = Image.open('ineuron2.png')
# st.image(image)
...
if __name__ == '__main__':
    ...
    dataframe1 = pd.read_excel('march 16.xlsx')  # change the file name to the downloaded file downloaded from the "https://app.cpcbccr.com/AQI_India/"
